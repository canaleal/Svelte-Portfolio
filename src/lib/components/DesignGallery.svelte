...
<div class="bg-primary  pt-32 flex flex-col ">
	<div class="flex-1 justify-end text-right px-64  align-bottom">
...
<div
	id="projects"
	class="grid  grid-cols-1 md:grid-cols-2  lg:grid-cols-3   gap-8 py-4 overflow-hidden px-8 lg:px-64"
>
	{#each ART as art, i}
