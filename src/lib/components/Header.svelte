<script lang="ts">
	...
	function launchSatellite() {
		...
		setTimeout(() => {
			launch = false;
		}, 10000); // the same duration as your animation
	}
</script>

<section class="bg-dark flex flex-col lg:flex-row   h-screen overflow-hidden about">
	<div class="flex-1 flex flex-col px-8 py-8 justify-between text-white border-r-2 border-gray-300">
		<div class="flex flex-col slide-in-top">
			<About />
		...
		<div class="flex justify-center">
			<NavbarArrow url={'#projects'} text="Projects" />
		</div>
	</div>
	<div class="flex-2 solar-system ">
		...
		<div class="orbit asteroid-belt asteroid-belt-sm"/>
		...
		<div class="orbit asteroid-belt asteroid-belt-lg"/>
	</div>
