import type { SMALL, MEDIUM, LARGE, FULL_STACK, MOBILE, REST_API, DATABASE, MACHINE_LEARNING, ALGORITHMS, UI, ALL, IN_DEVELOPMENT, COMPLETE, WEB_MOCK, LAPTOP_MOCK, PHONE_MOCK, WATCH_MOCK, TABLET_MOCK } from "$lib/features/project/constants/project";
