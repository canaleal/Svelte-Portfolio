...
describe('getDevicon', () => {
	...
	it('should handle variations of the provided tool string', () => {
		...
		const expectedOutput =
			'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original-plain.svg';
		expect(getDevicon(toolString)).toEqual(expectedOutput);
	});
	...
	it('should handle different variations of provided tool string', () => {
		...
		const expectedOutput =
			'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original-line.svg';
		expect(getDevicon(toolString)).toEqual(expectedOutput);
	});
	...
	it('should handle variations of the provided tool string', () => {
		...
		const expectedOutput =
			'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-wordmark.svg';
		expect(getDevicon(toolString)).toEqual(expectedOutput);
	});
